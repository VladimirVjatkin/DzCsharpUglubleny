...
// Для создания базы данных в PostgreSQL вам потребуется установить и настроить Npgsql.EntityFrameworkCore.PostgreSQL NuGet пакет.

namespace DZNetTest.Models
{
    public class ChatDbContext: DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
           optionsBuilder.LogTo(Console.WriteLine)
                .UseLazyLoadingProxies().UseNpgsql("Host = localhost; Username = example; Password = example; Database = chatdb;");
        }
